Android sqite database classes from android-m-preview-1 tag now *partially* working, using Android-sqlcipher-cursor-query-native-driver-test to provide native sqlite functionality
...
android.util.Log.v("Test", "column count: " + c1.getColumnCount()); // should be 1
if (c1 != null && c1.moveToFirst()) {
  android.util.Log.v("Test", "position: " + c1.getPosition());
  android.util.Log.v("Test", "column 1 name: " + c1.getColumnName(0));
  android.util.Log.v("Test", "column 1 type: " + c1.getType(0));
  android.util.Log.v("Test", "column 1 text [string]: " + c1.getString(0));
}
