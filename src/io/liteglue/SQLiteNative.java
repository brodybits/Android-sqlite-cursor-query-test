...
public class SQLiteNative {
  ...
  /** Interface to C language function: <br> <code> int sqlc_db_changes(sqlc_handle_t db); </code>    */
  public static native int sqlc_db_changes(long db);
  ...
  /** Interface to C language function: <br> <code> int sqlc_query_fill_window(sqlc_handle_t st, int w, int startPos, int offsetParam, int maxRead, int lastPos); </code>    */
  public static native int sqlc_query_fill_window(long st, int w, int startPos, int offsetParam, int maxRead, int lastPos);
  ...
  /** Interface to C language function: <br> <code> int sqlc_st_bind_parameter_count(sqlc_handle_t st); </code>    */
  public static native int sqlc_st_bind_parameter_count(long st);
  ...
  /** Interface to C language function: <br> <code> int sqlc_st_clear_bindings(sqlc_handle_t st); </code>    */
  public static native int sqlc_st_clear_bindings(long st);
  ...
  /** Interface to C language function: <br> <code> int sqlc_st_reset(sqlc_handle_t st); </code>    */
  public static native int sqlc_st_reset(long st);
